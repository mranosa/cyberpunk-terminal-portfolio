  ...
  return (
    ...
    >
      ...
      <motion.div
        ...
        className={`bg-black/50 border-2 ${levelColor.split(' ')[1]} p-8 text-center`}
      >
        <motion.div
          initial={{ scale: 0 }}
          animate={{ scale: 1 }}
          ...
          className="mb-4"
        >
          <span className={`text-7xl font-bold font-mono ${levelColor.split(' ')[0]}`}>
            {result.overallScore}
          </span>
      ...
      {result.highlights.length > 0 && (
        <motion.div
          ...
          className="bg-black/50 border border-cyber-purple/30 p-4"
        >
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
        ...
        >
          <div className="flex items-center justify-between mb-3">
            <h3 className="text-cyber-purple font-mono text-sm">MBTI // {result.mbti.type}</h3>
            <span className="text-white font-bold">{result.mbti.score}%</span>
          </div>
          <p className="text-gray-400 text-sm mb-3">{result.mbti.typeName}</p>
          {result.mbti.specialLabel && (
            <div className="text-cyber-green text-xs font-mono mb-2">{result.mbti.specialLabel}</div>
          )}
          <p className="text-gray-500 text-xs">{result.mbti.description}</p>
        ...
        <motion.div
          ...
          className="bg-black/50 border border-cyber-green/30 p-4"
        >
          <div className="flex items-center justify-between mb-3">
        ...
        <motion.div
          ...
          className="bg-black/50 border border-solar-yellow/30 p-4"
        >
          <div className="flex items-center justify-between mb-3">
        ...
        <motion.div
          ...
          className="bg-black/50 border border-alert-red/30 p-4"
        >
          <div className="flex items-center justify-between mb-3">
      ...
      <motion.div
        ...
        className="bg-black/50 border border-cyber-cyan/30 p-4"
      >
